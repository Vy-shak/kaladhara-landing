...
function About() {
  return (
    <section className='w-full gap-y-6 flex-col flex pt-8 sm:pt-12 lg:pt-16 justify-center items-center'>
      <div className='flex flex-col sm:gap-y-1  justify-center items-center'>
        <span className='text-4xl border-y-2 border-t-KalaYellow-500 border-b-KalaRed-500 sm:border-y-3 lg:border-y-4 sm:text-6xl lg:text-7xl xl:text-8xl 2xl:text-9xl font-extrabold whitespace-nowrap'>KALA DHARA</span>
        <Dots/>
      </div>
        <div className='w-full gap-x-3 h flex justify-center items-center text-justify'>
